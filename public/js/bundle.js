...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY24tOTAiLCJhIjoiY2s3dzNjdzZvMDA1aDNwbnpqeWI1ZnZycyJ9.A4WUAgBYykiC4c8oo1TWmg';
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map); // extends map bound to include current location
...
var passwordForm = document.querySelector('.form-user-password'); // VALUES
// DELEGATION
